...
public class RSDrawingArea extends DrawingArea {
	...
	private static int[] anIntArray1399;
	public static int topX;
	public static int width;
	public static int[] pixels;
	public static int topY;
	public static int bottomY = 0;
	private static int[] anIntArray1405;
	...
	private static void drawVerticalLineAlpha(int drawX, int drawY,
	...
	private static void startSetAreaColor(int drawX, int drawY, int color) {
	...
	private static void method1425(int i, int i_35_, int i_36_, int i_37_) {
		if (i_36_ == 0) {
	...
	private static void drawHorizontalLineAlpha(int i, int i_89_, int i_90_,
												int i_91_, int i_92_) {
