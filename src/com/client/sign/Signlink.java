...
//	private static String CACHE_NAME = "runehub-cache";
	...
	static {
		File file = new File(System.getProperty("user.home") + "/" + ClientProperties.getInstance().getCacheName() + "/");
		if (!file.exists()) {
			file.mkdir();
		}
		file = new File(System.getProperty("user.home") + "/" + ClientProperties.getInstance().getCacheName() + "/");
		if (!file.exists()) {
			file.mkdir();
		}
	}
	...
	@Override
	public void run() {
//		System.out.println("Running signlink");
		active = true;
	...
	public static final String getCacheDirectory() {
		...
		String cacheName = ClientProperties.getInstance().getCacheName();
