...
import com.client.graphics.interfaces.runehub.AnimationDefinitionList;
...
public final class AnimationDefinition {
    ...
    public static void dumpList() {
        ...
        try {
            JsonSerializer<AnimationDefinitionList> serializer = new JsonSerializer<>(AnimationDefinitionList.class);
            //			FileWriter fw = new FileWriter(System.getProperty("user.home") + "/Desktop/animation_data.json");
            //				fw.write("Id: " + itemDefinition.anInt352 + "\n");
            ArrayList<AnimationDefinition> definitions = new ArrayList<>(Arrays.asList(anims));
            AnimationDefinitionList list = new AnimationDefinitionList();

            list.getDefinitions().addAll(definitions);



            serializer.write(new File(System.getProperty("user.home") + "/Desktop/animation_data.json"),serializer.serialize(list));
//			fw.close();
        } catch (Exception e) {
